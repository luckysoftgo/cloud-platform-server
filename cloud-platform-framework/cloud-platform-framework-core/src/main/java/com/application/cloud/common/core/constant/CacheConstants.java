...
public interface CacheConstants {
	 ...
	 * oauth 客户端信息
	 */
	String CLIENT_DETAILS_KEY = "cloud_oauth:client:details";
	 ...
	 * redis 重新加载 路由信息
	 */
	String ROUTE_REDIS_RELOAD_TOPIC = "userclient_redis_route_reload_topic";
	
	/**
	 * redis 重新加载客户端信息
	 */
	String CLIENT_REDIS_RELOAD_TOPIC = "userclient_redis_client_reload_topic";
