...
package com.application.cloud.common.log.event;
...
public class SysLogListener implements InitializingBean {
	...
	private final CloudLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		JacksonSensitiveFieldUtil.registerCustomModule(new CloudJavaTimeModule());
	}
}
