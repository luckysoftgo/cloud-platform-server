package com.application.cloud.common.security.component;
...
import com.application.cloud.common.security.service.CloudUserDetailsService;
...
public class CloudCustomOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
	...
	public OAuth2AuthenticatedPrincipal introspect(String token) {
		...
		if (AuthorizationGrantType.CLIENT_CREDENTIALS.equals(oldAuthorization.getAuthorizationGrantType())) {
			return new CloudClientCredentialsOAuth2AuthenticatedPrincipal(
		...
		try {
			...
			userDetails = optional.get().loadUserByUser((CloudUser) tokenPrincipal);
		...
		// 注入客户端信息，方便上下文中获取
		CloudUser cloudUser = (CloudUser) userDetails;
		Objects.requireNonNull(cloudUser).getAttributes().put(SecurityConstants.CLIENT_ID,
