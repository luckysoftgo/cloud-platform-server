...
public class CloudResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public CloudBearerTokenExtractor pigBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new CloudCustomOpaqueTokenIntrospector(authorizationService);
	}
