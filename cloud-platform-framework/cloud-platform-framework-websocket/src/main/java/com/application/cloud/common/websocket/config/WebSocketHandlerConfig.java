package com.application.cloud.common.websocket.config;

import com.application.cloud.common.websocket.custom.CloudSessionKeyGenerator;
import com.application.cloud.common.websocket.custom.UserAttributeHandshakeInterceptor;
import com.application.cloud.common.websocket.handler.CustomPlanTextMessageHandler;
import com.application.cloud.common.websocket.handler.CustomWebSocketHandler;
import com.application.cloud.common.websocket.handler.PingJsonMessageHandler;
import com.application.cloud.common.websocket.handler.PlanTextMessageHandler;
import com.application.cloud.common.websocket.holder.MapSessionWebSocketHandlerDecorator;
import com.application.cloud.common.websocket.holder.SessionKeyGenerator;
