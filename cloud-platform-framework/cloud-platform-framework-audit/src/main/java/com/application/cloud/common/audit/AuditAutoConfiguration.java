package com.application.cloud.common.audit;

import com.application.cloud.admin.api.feign.RemoteAuditLogService;
import com.application.cloud.common.audit.aop.AuditAspect;
import com.application.cloud.common.audit.handle.DefaultAuditLogHandle;
import com.application.cloud.common.audit.handle.IAuditLogHandle;
import com.application.cloud.common.audit.handle.ICompareHandle;
import com.application.cloud.common.audit.handle.JavesCompareHandle;
