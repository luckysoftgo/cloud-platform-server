...
package com.application.cloud.common.xss.core;

import cn.hutool.core.util.CharsetUtil;
import com.application.cloud.common.xss.config.CloudXssProperties;
import com.application.cloud.common.xss.utils.XssUtil;
...
public class DefaultXssCleaner implements XssCleaner {
	...
	private final CloudXssProperties properties;
	...
	public String clean(String bodyHtml) {
		...
		CloudXssProperties.Mode mode = properties.getMode();
		if (CloudXssProperties.Mode.escape == mode) {
			// html 转义
