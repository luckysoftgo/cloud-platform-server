package com.application.cloud.auth.support.base;

import cn.hutool.core.util.BooleanUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.application.cloud.common.core.constant.CommonConstants;
import com.application.cloud.common.security.service.CloudRedisOAuth2AuthorizationService;
import com.application.cloud.common.security.util.OAuth2ErrorCodesExpand;
import com.application.cloud.common.security.util.ScopeException;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		try {
			...
			CloudRedisOAuth2AuthorizationService redisOAuth2AuthorizationService = (CloudRedisOAuth2AuthorizationService) this.authorizationService;
