...
public class CustomeOAuth2TokenCustomizer implements OAuth2TokenCustomizer<OAuth2TokenClaimsContext> {
	...
	public void customize(OAuth2TokenClaimsContext context) {
		...
		CloudUser cloudUser = (CloudUser) context.getPrincipal().getPrincipal();
		claims.claim(SecurityConstants.DETAILS_USER_ID, cloudUser.getId());
		claims.claim(SecurityConstants.DETAILS_USERNAME, cloudUser.getUsername());
	}
