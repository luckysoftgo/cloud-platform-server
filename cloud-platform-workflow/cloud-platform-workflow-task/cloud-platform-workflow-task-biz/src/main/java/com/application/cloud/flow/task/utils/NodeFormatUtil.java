package com.application.cloud.flow.task.utils;
...
import com.application.cloud.flow.task.constant.NodeTypeEnum;
...
import com.application.cloud.flow.task.entity.ProcessNodeRecordAssignUser;
import com.application.cloud.flow.task.service.IProcessInstanceRecordService;
import com.application.cloud.flow.task.service.IProcessNodeRecordAssignUserService;
import com.application.cloud.flow.task.service.IRemoteService;
import com.application.cloud.flow.task.vo.NodeVo;
import com.application.cloud.flow.task.vo.UserVo;
			...
			if (StrUtil.isNotBlank(processInstanceId)) {
				...
				if (o != null) {
					...
					if (StrUtil.isNotBlank(jsonString)) {
						...
						List<Long> userIdList = nodeUserDtoList.stream().map(NodeUser::getId).collect(Collectors.toList());
