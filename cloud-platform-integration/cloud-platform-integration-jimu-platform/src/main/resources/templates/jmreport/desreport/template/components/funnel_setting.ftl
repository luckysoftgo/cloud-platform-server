<script type="text/x-template" id="funnel-setting-template">
    <Submenu name="6" style="border-bottom: inset 1px;" class="rightFontSize dataSourceForm">
        ...
        <div class="blockDiv" style="padding-bottom: 10px">
            <Row class="ivurow">
                <p>图形间距&nbsp;&nbsp;</p>
                <slider v-model="funnelOptions.gap" @on-change="onFunnelChange"
            ...
            <Row class="ivurow">
                <p>宽度(%)&nbsp;&nbsp;&nbsp;</p>
                <slider :tip-format="util.percentFormat" :value="util.getNumberFromPercent(funnelOptions.width)"
                        @on-change="(value)=>onPercentChange(value, 'funnelOptions.width','onFunnelChange')"
                        style="margin-top: -9px;width: 139px;margin-left: 5px;"></slider>
            </Row>
        </div>
    </Submenu>
