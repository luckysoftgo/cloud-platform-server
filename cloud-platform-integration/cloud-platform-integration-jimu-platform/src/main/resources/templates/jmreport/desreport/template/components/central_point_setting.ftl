    ...
    <div>
        <Submenu name="5" style="border-bottom: inset 1px; " class="rightFontSize">
            ...
            <div class="blockDiv" style="padding-bottom: 10px">
                <Row class="ivurow">
                    <p>x轴&nbsp;&nbsp;</p>
                    <i-input size="small" type="number" v-model="centralPoint.center[0]" @on-change="onMarginChange"
                             style="margin-left: 5px;width: 164px" :value="centralPoint.center[0]"></i-input>
                </Row>
                <Row class="ivurow">
                    <p style="margin-bottom: 10px;">y轴&nbsp;&nbsp;</p>
                    <i-input size="small" type="number" v-model="centralPoint.center[1]" @on-change="onMarginChange"
                             style="margin-left: 5px;width: 164px" :value="centralPoint.center[1]"></i-input>
                </Row>
            </div>
        </Submenu>
    </div>
