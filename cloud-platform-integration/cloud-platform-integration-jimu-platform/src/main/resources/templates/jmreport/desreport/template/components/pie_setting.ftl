<script type="text/x-template" id="pie-setting-template">
    <Submenu name="4" style="border-bottom: inset 1px;" class="rightFontSize">
        ...
        <div class="blockDiv" style="padding-bottom: 10px">
            <Row class="ivurow">
                <p>环形饼图&nbsp;&nbsp;</p>
                <i-switch size="small" style="margin-left: 117px;" v-model="pieOption.isRadius"
                          @on-change="pieTypeChange"/>
            </Row>
            <Row class="ivurow">
                <p>南丁格尔玫瑰&nbsp;&nbsp;</p>
                <i-switch size="small" style="margin-left: 93px;" v-model="pieOption.isRose"
                          @on-change="pieTypeChange('1')"/>
            </Row>
            <template v-if="pieOption.isRadius">
                <Row class="ivurow">
                    <p>饼块半径&nbsp;&nbsp;</p>
                    <i-input size="small" v-model="pieOption.radius[1]" @on-blur="onPieChange"
                             class="iSelect"></i-input>
                </Row>
                <Row class="ivurow">
                    <p>内环半径&nbsp;&nbsp;</p>
                    <i-input size="small" v-model="pieOption.radius[0]" @on-blur="onPieChange"
                             class="iSelect"></i-input>
                </Row>
            </template>
            ...
            <Row class="ivurow">
                <span>最小角度&nbsp;&nbsp;</span>
                <i-input size="small" type="number" v-model="pieOption.minAngle" @on-blur="onPieChange"
                         class="iSelect"></i-input>
            </Row>
        </div>
    </Submenu>
