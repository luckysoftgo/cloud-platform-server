<script type="text/x-template" id="background-setting-template">
    <Submenu name="background" style="border-bottom: inset 1px;" class="rightFontSize">
        ...
        <div class="blockDiv" style="padding-bottom: 20px">
            <Row class="ivurow">
                <p>启用背景&nbsp;&nbsp;</p>
                <i-switch size="small" style="margin-left: 117px;" v-model="chartBackground.enabled"
                          @on-change="chartBackgroundChange"/>
            </Row>
            <Row class="ivurow">
                <p>背景颜色&nbsp;&nbsp;</p>
                <Col>
                <i-input class="iSelect" v-model="chartBackground.color" size="small"
                         @on-change="chartBackgroundChange">
                    <span slot="append">
                        <color-picker class="colorPicker" v-model="chartBackground.color" :editable="false" alpha
                                      :transfer="true" size="small" @on-change="chartBackgroundChange"/>
                    </span>
                </i-input>
                </Col>
            </Row>
            <Row class="ivurow">
                ...
                <div style="height: 0">
                    <Upload
                        ...
                        <i-button v-if="chartBackground.image" style="margin-left:106px" type="primary" size="small">
                            修改
                        </i-button>
