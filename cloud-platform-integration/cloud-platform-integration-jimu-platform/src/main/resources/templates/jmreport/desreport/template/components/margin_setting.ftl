    ...
    <div>
        <Submenu name="5" style="border-bottom: inset 1px;" class="rightFontSize">
            ...
            <div class="blockDiv" style="padding-bottom: 10px">
                <Row class="ivurow">
                    <p>左边距(%)</p>
                    <slider :tip-format="percentFormat" :value="getNumberFromPercent(marginOptions.left)"
                            @on-change="(value)=>onPercentChange(value, 'marginOptions.left','onPieChange')"
                            style="margin-top: -9px;width: 135px;margin-left: 5px;"></slider>
                </Row>

                <Row class="ivurow" v-if="marginOptions.right">
                    <p>右边距(%)</p>
                    <slider :tip-format="percentFormat" :value="getNumberFromPercent(marginOptions.right)"
                            @on-change="(value)=>onPercentChange(value, 'marginOptions.right','onPieChange')"
                            style="margin-top: -9px;width: 135px;margin-left: 5px;"></slider>
                </Row>
                <Row class="ivurow">
                    <p>顶边距&nbsp;&nbsp;</p>
                    <slider v-model="marginOptions.top" @on-change="onMarginChange"
                            style="margin-top: -9px;width: 148px;margin-left: 5px;"></slider>
                </Row>
                <Row class="ivurow">
                    <p style="margin-bottom: 10px;">底边距&nbsp;&nbsp;</p>
                    <slider v-model="marginOptions.bottom" @on-change="onMarginChange"
                            style="margin-top: -9px;width: 148px;margin-left: 5px;"></slider>
                </Row>
            </div>
        </Submenu>
