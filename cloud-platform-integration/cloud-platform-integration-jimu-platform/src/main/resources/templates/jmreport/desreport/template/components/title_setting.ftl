    ...
    <div class="title-setting-fontsize">
        <Submenu name="1" style="border-bottom: inset 1px;">
            ...
            <div class="blockDiv">
                <Row class="ivurow">
                    <p>显示&nbsp;&nbsp;</p>
                    <i-switch size="small" style="margin-left: 142px;" v-model="titleOption.show"
                              @on-change="onTitleChange"/>
                </Row>

                <Row class="ivurow">
                    <p>标题文字&nbsp;&nbsp;</p>
                    <i-input class="rightFontSize iSelect" size="small" v-model="titleOption.text"
                             @on-blur="onTitleChange"></i-input>
                </Row>
                <Row class="ivurow" v-if="typeof titleOption.textStyle_color !== 'undefined'">
                    <p>字体颜色&nbsp;&nbsp;</p>
                    <Col>
                    <i-input v-model="titleOption.textStyle_color" size="small" class="rightFontSize iSelect"
                             @on-change="onTitleChange">
                    <span slot="append">
                        <color-picker class="colorPicker" v-model="titleOption.textStyle_color" :editable="false"
                                      :transfer="true" size="small" @on-change="onTitleChange"/>
                    </span>
                    </i-input>
                    </Col>
                </Row>
                <Row class="ivurow">
                    ...
                    <i-select size="small" class="rightFontSize iSelect" v-model="titleOption.textStyle_fontWeight"
                              @on-change="onTitleChange">
                ...
                <Row class="ivurow">
                    <p>字体大小&nbsp;&nbsp;</p>
                    <i-input size="small" type="number" v-model="titleOption.textStyle_fontSize"
                             @on-change="onTitleChange"
                             class="iSelect rightFontSize"></i-input>
                </Row>
                <Row class="ivurow">
                    <p style="margin-bottom: 10px;">标题位置&nbsp;&nbsp;</p>
                    <i-select size="small" class="iSelect rightFontSize" v-model="titleOption.left"
                              @on-change="onTitleChange" style="width: 132%;">
                ...
                <Row class="ivurow">
                    <p>顶边距&nbsp;&nbsp;</p>
                    <slider v-model="titleOption.top" @on-change="onTitleChange" :tip-format="formatTop"
                            style="margin-top: -9px;width: 150px;margin-left: 5px;"></slider>
                </Row>
            </div>
        </Submenu>
    </div>
