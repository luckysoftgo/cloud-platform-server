...
<script type="text/x-template" id="barcode-setting-template">
    <div :style="{height: settingsDivHeight+'px'}" class="jm-setting-container pb120"
         style="padding-top: 10px;padding-left: 7px">
        <i-form class="jm-form-barcode dataSourceForm rightFontSize">
            <form-item label="条形码内容">
                <i-input v-model="barcodeContent" id="barcodeContent" type="textarea" :rows="2"
                         @on-blur="onBarcodeChange"></i-input>
            </form-item>

            <form-item label="条间距">
                <i-input v-model="width" placeholder="请输入条间距" :min="1" type="number"
                         @on-change="onBarcodeChange"></i-input>
            </form-item>

            <form-item label="高度">
                <i-input v-model="height" placeholder="请输入高度" :min="1" type="number"
                         @on-change="onBarcodeChange"></i-input>
            </form-item>
            ...
            <form-item label="条颜色" class="colorHeight">
                <i-input v-model="lineColor" size="small" style="width: 111px;" @on-change="onBarcodeChange">
                    <span slot="append">
                        <color-picker class="colorPicker colorHeight" v-model="lineColor" :editable="false" alpha
                                      :transfer="true" size="small" @on-change="onBarcodeChange"/>
                    </span>
                </i-input>
            </form-item>
            ...
            <form-item label="背景色" class="colorHeight">
                <i-input v-model="background" size="small" style="width: 111px;" @on-change="onBarcodeChange">
                    <span slot="append">
                        <color-picker class="colorPicker" v-model="background" :editable="false" alpha :transfer="true"
                                      size="small" @on-change="onBarcodeChange"/>
                    </span>
                </i-input>
            </form-item>
            ...
            <template v-if="displayValue">
                ...
                <form-item label="文字大小">
                    <i-input v-model="fontSize" placeholder="请输入文字大小" :min="1" type="number"
                             @on-change="onBarcodeChange"></i-input>
                </form-item>
