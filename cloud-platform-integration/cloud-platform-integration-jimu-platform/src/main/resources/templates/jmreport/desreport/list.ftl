                ...
                <tab-pane icon="md-desktop" label="报表设计" name="name1" class="jimu-tab">
                    <div style="display: flex;justify-content:space-between;margin-left:16px;margin-right: 38px;">
                        <div style="display: flex">
                            <input type="file" accept=".json" id="fileInput" ref="fileInput" style="display: none"
                                   @input="handleFileUpload">
                            <i-button size="small" icon="ios-cloud-upload-outline" style="margin-right: 5px;"
                                      type="primary" @click="uploadFile" v-if="menuitem!='recycleBin'">导入报表
                            </i-button>
                            <i-input size="small" v-model="name" @keyup.enter.native="enterSearchClick"
                                     placeholder="搜索报表名称"></i-input>
                        </div>
                        <div class="page">
                                ...
                                <div style="margin-left: 14%;" v-else>
                                    <a class="opt-show" @click="handleReduction(item)">
                                        <Tooltip content="还原报表" placement="top" class="tooltip-footer-font-size">
                                            <i class="ivu-icon ivu-icon-ios-refresh"
                                               style="font-size: 16px;transform: rotate(200deg)"></i>
                                        </Tooltip>
                                    </a>
                                    <a class="opt-show" @click="handleRealDelete(item)">
                                        <Tooltip content="彻底删除报表" placement="top" transfer
                                                 class="tooltip-footer-font-size">
                    ...
                    <div v-else style="padding: 10px 10px">
                        <i-button v-if="menuitem!='recycleBin'" type="primary" @click="createExcel" size="small"
                            ...
                            <template slot-scope="{ row, index }" slot="action">
                                ...
                                <template v-else>
                                    <a class="opt-list-show" @click="handleReduction(row)">
                                        <Tooltip content="还原报表" placement="top" transfer
                                                 class="tooltip-footer-font-size">
                                            <i class="ivu-icon ivu-icon-ios-refresh"
                                               style="font-size: 16px;transform: rotate(200deg)"></i>
                                        </Tooltip>
