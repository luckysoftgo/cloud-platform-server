<script type="text/x-template" id="series-setting-template">
    <Submenu name="15" style="border-bottom: inset 1px;" class="dataSourceForm">
        ...
        <div class="blockDiv" style="padding-bottom: 10px">
            <Row class="ivurow">
                <p>显示&nbsp;&nbsp;</p>
                <i-switch size="small" style="margin-left: 141px;" v-model="seriesOption.show"
                          @on-change="onSeriesLabelChange"/>
            </Row>
            <Row class="ivurow">
                <p>字体大小&nbsp;&nbsp;</p>
                <i-input class="rightFontSize iSelect" size="small" type="number"
                         v-model="seriesOption.textStyle_fontSize" @on-blur="onSeriesLabelChange"></i-input>
            </Row>
            <Row class="ivurow" v-if="typeof seriesOption.textStyle_color !== 'undefined'">
                <p>字体颜色&nbsp;&nbsp;</p>
                <Col>
                <i-input class="rightFontSize iSelect" v-model="seriesOption.textStyle_color" size="small"
                         @on-change="onSeriesLabelChange">
                    <span slot="append">
                        <color-picker class="colorPicker" v-model="seriesOption.textStyle_color" :editable="false"
                                      :transfer="true" size="small" @on-change="onSeriesLabelChange"/>
                    </span>
                </i-input>
                </Col>
            </Row>
            <Row class="ivurow rightFontSize">
                <p>字体粗细&nbsp;&nbsp;</p>
                <i-select size="small" class="iSelect" v-model="seriesOption.textStyle_fontWeight"
                          @on-change="onSeriesLabelChange" style="width: 115%">
            ...
            <Row class="ivurow rightFontSize">
                ...
                <i-select size="small" class="iSelect" v-model="seriesOption.position" @on-change="onSeriesLabelChange">
                    <i-option class="rightFontSize" v-for="(item,index) in seriesOption.labelPositionArray"
            ...
            <Row class="ivurow rightFontSize">
                ...
                <input-number :max="90" :min="-90" size="small" v-model="seriesOption.rotate"
                              @on-change="onSeriesLabelChange"/>
                </i-select>
            </Row>
            <Row class="ivurow rightFontSize">
                <p style="margin-bottom: 10px;">是否显示数值&nbsp;&nbsp;</p>
                <i-switch size="small" style="margin-left: 6px;" v-model="izShowNumber"
                          @on-change="onSeriesFormatterChange"/>
                </i-select>
            </Row>
        </div>
    </Submenu>
