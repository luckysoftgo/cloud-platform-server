<script type="text/x-template" id="print-setting-template">
    <div>
        <Modal :loading="true" v-model="show" :width="500" @on-ok="onPrintSettingSave" @on-cancel="onPrintSettingCancel"
               class="print-setting expression">
            <p slot="header">
            <span>打印设置
               <Tooltip :transfer="true" content="打印文档" placement="top">
                  <a class="jimu-table-tip help-color" href="https://help.jeecg.com/jimureport/print.html"
            ...
            <i-form label-colon :label-width="90">
                ...
                <Row style="margin-top: 8px">
                    ...
                    <i-col span="18">
                        <i-input type="number" v-model="marginX" style="width: 40%"
                                 @on-change="onPaperMarginXChange"></i-input>
                        -
                        <i-input type="number" v-model="marginY" style="width: 40%"
                                 @on-change="onPaperMarginYChange"></i-input>
                    </i-col>
                </Row>
