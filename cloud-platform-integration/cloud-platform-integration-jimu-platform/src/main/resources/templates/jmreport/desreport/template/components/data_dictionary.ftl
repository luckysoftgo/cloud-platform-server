<script type="text/x-template" id="data-dictionary">
    <div class="dictClass">
        <Modal
            ...
            <div style="margin-top: 10px">
                <i-table @on-selection-change="dictTableSelect" border stripe :columns="dictData.columns"
                         :data="dictData.data"
                         style="margin-top: 1%;">
            ...
            >
                <div slot="footer">
                    ...
                    <i-button :loading="createDictLoading" type="primary" @click="createDictOk('dictModel')">确定
                    </i-button>
                </div>
            ...
            >
                ...
                <div style="margin-top: 10px" v-if="recycleBinRows.length>0">
                    <i-button type="primary" size="small" style="cursor: pointer" @click="recycleBinBatch('recycle')">
                        批量取回
                    </i-button>
                    <i-button type="error" size="small" style="cursor: pointer" @click="recycleBinBatch('delete')">
                        批量刪除
                    </i-button>
                </div>
                <div style="margin-top: 10px">
                    <i-table border stripe :columns="recycleBin.columns" :data="recycleBin.data"
                        ...
                        <template slot-scope="{ row, index }" slot="action">
                            <i-button type="primary" size="small" style="cursor: pointer"
                                      @click="recycleBinRetrieve(row.id)">取回
                            </i-button>
                            <Poptip
                                    confirm
                                    placement="left"
            ...
            >
                <div slot="footer">
                    ...
                    <i-button :loading="createDictItemLoading" type="primary"
                              @click="createItemDictOk('dictItemModel')">确定
                    </i-button>
                </div>
                <i-form ref="dictItemModel" :model="dictItemModel" :rules="dictItemModelRule" :label-width="100"
                        class="dict">
