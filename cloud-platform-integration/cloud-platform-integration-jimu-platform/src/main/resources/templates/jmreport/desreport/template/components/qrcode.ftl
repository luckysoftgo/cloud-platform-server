...
<script type="text/x-template" id="qrcode-setting-template">
    <div style="height:auto;overflow: hidden;padding-bottom: 300px;padding-top: 10px;padding-left: 7px">
        <i-form class="jm-form-barcode dataSourceForm rightFontSize">
            ...
            <form-item label="宽度">
                <i-input v-model="width" placeholder="请输入宽度" :min="1" type="number" @on-blur="onCodeChange"
                         style="width: 99%"></i-input>
            </form-item>

            <form-item label="高度">
                <i-input v-model="height" placeholder="请输入高度" :min="1" type="number" @on-blur="onCodeChange"
                         style="width: 99%"></i-input>
            </form-item>
            ...
            <form-item label="前景色" class="colorHeight">
                <i-input v-model="colorDark" size="small" style="width: 111px;" @on-change="onCodeChange">
                    <span slot="append">
                        <color-picker class="colorPicker colorHeight" v-model="colorDark" :editable="false"
                                      :transfer="true" size="small" @on-change="onCodeChange"/>
                    </span>
                </i-input>
            </form-item>
            ...
            <form-item label="背景色" class="colorHeight">
                <i-input v-model="colorLight" size="small" style="width: 111px;" @on-change="onCodeChange">
                    <span slot="append">
                        <color-picker class="colorPicker" v-model="colorLight" :editable="false" :transfer="true"
                                      size="small" @on-change="onCodeChange"/>
                    </span>
                </i-input>
            </form-item>
        </i-form>
