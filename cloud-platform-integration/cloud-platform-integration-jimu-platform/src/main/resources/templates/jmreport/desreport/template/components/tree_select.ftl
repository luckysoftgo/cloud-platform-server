        ...
        <div tabindex="0" class="ivu-select-selection ivu-form-item-content">
            <div @mouseover="mouseover" @mouseleave="mouseleave">
                <div @click="treeSelectContentShow" style="line-height: 23px;">
                    <div v-for="(item,index) in multipleShowVal" v-if="index<2" :key="item"
            ...
            <div v-show="showTree" @mouseover="mouseover1" @mouseleave="mouseleave1" class="ivu-select-dropdown"
                 style="max-height: 200px;overflow-y:auto;z-index:9999;min-width:100%;width: auto">
