...
<script type="text/x-template" id="view-setting-template">
    <div style="">
        <Modal :loading="true" v-model="show" title="预览页工具条设置" :width="650" @on-ok="onViewSettingSave"
               @on-cancel="onViewSettingCancel" class="expression">
            ...
            <div style="padding: 9px;margin-top:2px;background: rgb(228 229 230);border-bottom: 1px solid #e0e2e4;height: 40px;text-align: left;">
                <div v-if="showViewToolbar" style="height: 22px;line-height: 22px;display: inline-block"
                     class="view-toolbar-container">
                    <Icon
