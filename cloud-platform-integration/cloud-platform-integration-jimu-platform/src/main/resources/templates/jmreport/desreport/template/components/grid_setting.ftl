    ...
    <div>
        <Submenu name="18" style="border-bottom: inset 1px;" class="rightFontSize">
            ...
            <div class="blockDiv">
                <Row class="ivurow">
                    <p>左边距&nbsp;&nbsp;</p>
                    <slider v-model="gridOptions.left" @on-change="onGridChange"
                            style="margin-top: -9px;width: 145px;margin-left: 5px;"></slider>
                </Row>
                <Row class="ivurow">
                    <p>顶边距&nbsp;&nbsp;</p>
                    <slider v-model="gridOptions.top" @on-change="onGridChange"
                            style="margin-top: -9px;width: 145px;margin-left: 5px;"></slider>
                </Row>
                <Row class="ivurow">
                    <p>右边距&nbsp;&nbsp;</p>
                    <slider v-model="gridOptions.right" @on-change="onGridChange"
                            style="margin-top: -9px;width: 145px;margin-left: 5px;"></slider>
                </Row>
                <Row class="ivurow">
                    <p style="margin-bottom: 10px;">底边距&nbsp;&nbsp;</p>
                    <slider v-model="gridOptions.bottom" @on-change="onGridChange"
                            style="margin-top: -9px;width: 145px;margin-left: 5px;"></slider>
                </Row>
            </div>
        </Submenu>
