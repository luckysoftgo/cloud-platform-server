<script type="text/x-template" id="pictorial-setting-template">
    <Submenu name="8" style="border-bottom: inset 1px;" class="rightFontSize">
        ...
        <div class="blockDiv" style="padding-bottom: 10px">
            <Row class="ivurow">
                <span title="建议上传至服务器本地,若上传至云服务器,可能导出/打印等功能不可用"
                      style="display: inline-block;line-height:0px;height: 20px;width: 53px;vertical-align:middle">图标</span>
                <Upload
            ...
            <Row class="ivurow">
                <p>图标大小&nbsp;&nbsp;</p>
                <i-input size="small" v-model="pictorialOptions.symbolSize" @on-blur="onPictorialChange"
                         class="iSelect"></i-input>
            </Row>
            <Row class="ivurow">
                <p>图标间距&nbsp;&nbsp;</p>
                <i-input type="number" size="small"
                         :value="util.getNumberFromPercent(pictorialOptions.symbolMargin,'!')"
                         @on-blur="(e)=>onPercentChange(e.target.value, 'pictorialOptions.symbolMargin','onPictorialChange','!')"
                         class="iSelect"><span slot="append">%</span></i-input>
            </Row>

            <Row class="ivurow">
                <p>最大值&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                <i-input size="small" v-model="pictorialOptions.symbolBoundingData" @on-blur="onPictorialChange"
                         class="iSelect"></i-input>
            </Row>

            <Row class="ivurow">
                <p>是否补全&nbsp;&nbsp;</p>
                <i-switch size="small" style="margin-left: 119px;" v-model="pictorialOptions.double"
                          @on-change="onPictorialChange"/>
            </Row>
            <Row class="ivurow" v-if="pictorialOptions.double">
                <p>透明度&nbsp;&nbsp;</p>
                <slider max="1" step="0.1" v-model="pictorialOptions.secondOpacity" @on-change="onPictorialChange"
                        style="margin-top: -9px;width: 110px;margin-left: 5px;"></slider>
            </Row>
        </div>
    </Submenu>
</script>
