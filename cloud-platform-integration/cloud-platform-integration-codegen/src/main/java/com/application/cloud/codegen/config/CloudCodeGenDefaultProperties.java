package com.application.cloud.codegen.config;
...
@ConfigurationProperties(prefix = CloudCodeGenDefaultProperties.PREFIX)
public class CloudCodeGenDefaultProperties implements InitializingBean {
	 ...
	 * 生成代码的包名
	 */
	private String packageName = "com.application.cloud";
	 ...
	 * 生成代码的后端路径
	 */
	private String backendPath = "cloud";
	
	/**
	 * 生成代码的前端路径
	 */
	private String frontendPath = "cloud-ui";
	
	/**
	 * 生成代码的作者
	 */
	private String author = "cloud";
	
	/**
	 * 生成代码的邮箱
	 */
	private String email = "sw@cloud.vip";
